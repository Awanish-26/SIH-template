...
def fertilizer(request):
    if request.method == "POST":  # soil data posted by user
        ...
        # if Crop nutrient in soil is less then Minimum crop nutrient then need to recommend fertlizer
        if newN <= N:
        ...
        return render(request, "pages/fertilizer.html", {"nitro": nitro, "RN": RN, "phos": phos, "RP": RP, "pot": pot, "RK": RK, "crop": crop})
